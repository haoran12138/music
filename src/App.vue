<template>
  <div id="app">
    <keep-alive :exclude="['SearchRes','mvplayer','singerdetail'，'Account']">
    ...
    <van-tabbar route>
      ...
      <van-tabbar-item :to="{name: 'Mine'}" icon="friends-o">我的音乐</van-tabbar-item>
      <van-tabbar-item :to="{name: 'Account'}" icon="setting-o">账户</van-tabbar-item>
    </van-tabbar>
  </div>
</template>
<script>
